...
const Login = () => {
	...
	return (
		<section style={{ height: '100vh' }} className='position-relative py-5  overflow-hidden bg-warning'>
			...
			<div className='container position-relative mx-auto'>
				<div className='row align-items-center'>
					<div className='col-12 col-lg-5 mb-5'>
						<div>
							<h2 className='display-5 fw-bold mb-4 text-white'>Keep Track of what you are spending</h2>
					...
					<div className='col-12 col-lg-5 ms-auto'>
						<div className='p-5 bg-light rounded text-center'>
							...
							<form onSubmit={formik.handleSubmit}>
								...
								/>
								{/* Err */}
								<div className='text-danger mb-2'>{formik.touched.email && formik.errors.email}</div>
								<input
